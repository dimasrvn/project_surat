...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Berkas Surat Keluar</title>
                ...
                <div class="page-title">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <a type="submit" class="btn btn-info btn-addon m-b-sm" href='<?php echo base_url()."index.php/surat_keluar/upload_gambar/".$ids."" ?>'><i class="fa fa-plus"></i> Tambah Berkas Surat Keluar</a>
                      <?php if($data != NULL){ ?>
                      <a type="submit" class="btn btn-success btn-addon m-b-sm pull-right" href='<?php echo base_url()."index.php/surat_keluar/download_berkas/".$ids."" ?>'><i class="fa fa-download"></i> Download Berkas</a>
                    <?php } ?>
                    </div>
                  </div>
                </div>
                                                    ...
                                                    <figure>
                                                        <figcaption>
                                                          ...
                                                          <div class="col-md-1 pull-right">
                                                            <a type="button" rel="tooltip" class="btn btn-danger btn-simple btn-xs" onclick="return confirm('Apakah Anda yakin ingin menghapus berkas ini ?')" href='<?php echo base_url()."index.php/surat_keluar/do_delete_gambar/".$d->id_surat."/".$d->id_berkas."" ?>'>

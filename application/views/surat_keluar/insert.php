            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/surat_keluar/do_insert"?>" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tembusan" required>
                            </div>
                        </div>
                        <div class="form-group">

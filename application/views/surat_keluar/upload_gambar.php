            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                   ...
                   <form id='form' method="POST" action="<?php echo base_url()."index.php/surat_keluar/"?>" enctype="multipart/form-data">
                   <div class="row">
                        <div class="col-md-8">
  ...
  <script type="text/javascript">
 	 $(document).ready(function(){
        $('#files').change(function(){
 		  ...
 		  {
 		   $.ajax({
 		    url:"<?php echo base_url(); ?>index.php/surat_keluar/upload", //base_url() return http://localhost/tutorial/codeigniter/
 		    method:"POST",
 		    data:form_data,
 		    contentType:false,
 		    cache:false,

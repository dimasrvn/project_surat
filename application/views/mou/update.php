            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/mou/do_update/".$id.""?>" enctype="multipart/form-data">
                      <div class="row">
                      ...
                      <a href="<?php echo base_url()."index.php/mou"?>" class="pull-left" style="color:gray; text-decoration:underline;"><br><i class="fa fa-angle-left"></i> Kembali ke daftar MOU</a>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function(){
        $('#no').change(function(){
              ...
              if(no != ''){
                   $.ajax({
                        url:"<?php echo base_url(); ?>index.php/mou/check_no_availability",
                        method:"POST",
                        data:{no:no},

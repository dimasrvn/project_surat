...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Berkas ND Direktur Utama</title>
            ...
            <div class="page-inner">
                ...
                <div class="page-title">
                  ...
                  <div class="page-breadcrumb">
                    ...
                    <li><a href="<?php echo base_url() ?>/index.php/ND_dirut">ND Direktur Utama</a></li>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <?php
                        ...
                        {$ids = 0;}
                      ?>
                      <a type="submit" class="btn btn-default btn-addon m-b-sm" href='<?php echo base_url()."index.php/ND_dirut/" ?>'><i class="fa fa-angle-left"></i> Kembali</a>
                      <a type="submit" class="btn btn-info btn-addon m-b-sm" href='<?php echo base_url()."index.php/ND_dirut/upload_gambar/".$ids."" ?>'><i class="fa fa-plus"></i> Tambah Berkas ND Direktur Utama</a>
                      <?php if($data != NULL){ ?>
                      <a type="submit" class="btn btn-success btn-addon m-b-sm pull-right" href='<?php echo base_url()."index.php/ND_dirut/download_berkas/".$ids."" ?>'><i class="fa fa-download"></i> Download Berkas</a>
                    <?php } ?>
                    </div>
                  </div>
                </div>
                                                    ...
                                                    <figure>
                                                        <figcaption>
                                                          ...
                                                          <div class="col-md-1 pull-right">
                                                            <a type="button" rel="tooltip" class="btn btn-danger btn-simple btn-xs" onclick="return confirm('Apakah Anda yakin ingin menghapus berkas ini ?')" href='<?php echo base_url()."index.php/ND_dirut/do_delete_gambar/".$d->id_surat."/".$d->id_berkas."" ?>'>

      ...
      <div class="page-inner">
          ...
          <div class="page-title">
            ...
            <div class="page-breadcrumb">
              ...
              <li class="active">Tambah Disposisi Surat Masuk Direktur Keuangan</li>
              </ol>
            </div>
            <br>
            <div class="row">
            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/surat_masuk/do_disposisi_2/".$id.""?>" enctype="multipart/form-data">
                      <div class="row">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Isi Disposisi</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" rows="3" name="disdirkeu" required><?php echo $disdirkeu ?></textarea>
                            </div>
                        </div>
                      </div>

    ...
    <main class="page-content content-wrap">
      ...
      <div class="page-inner">
          ...
          <div class="page-title">
            <h3>Edit Surat masuk - <b><?php echo $no ?></h3>
            <div class="page-breadcrumb">
              ...
              <li class="active">Edit Surat masuk - <b><?php echo $no ?></b></li>
              </ol>
            </div>
            <br>
            <div class="row">
            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/surat_masuk/do_update/".$id.""?>" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="date" class="form-control" name="tanggal_surat" value="<?php echo $tanggal_surat?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tanggal Terima</label>
                            <div class="col-sm-3">
                                <input type="date" class="form-control" name="tanggal_terima" value="<?php echo $tanggal_terima?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                      ...
                      <a href="<?php echo base_url()."index.php/surat_masuk"?>" class="pull-left" style="color:gray; text-decoration:underline;"><br><i class="fa fa-angle-left"></i> Kembali ke daftar surat masuk</a>

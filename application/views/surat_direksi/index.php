...
<html>
  <head>
    <title>Surat Perintah Direksi</title>
    <?php echo $head ?>
  </head>
      ...
      <div class="page-inner">
          ...
          <div class="page-title">
            ...
            <div class="page-breadcrumb">
              ...
              <li class="active">Surat Perintah Direksi</li>
              </ol>
            </div>
            <br>
            <div class="row">
              ...
              <?php
                ...
                if($level == 'sekertaris'){
                  ?>
                  <div class="col-md-7">
                    <a type="submit" class="btn btn-info btn-addon m-b-md" href='<?php echo base_url()."index.php/surat_direksi/insert" ?>'><i class="fa fa-plus"></i> Tambah Surat Perintah Direksi</a>
                  </div>
                  <?php
                }
                  ...
                  <tr>
                    ...
                    <td class="td-actions text-right">
                      <?php
                        ...
                        if($level == 'sekertaris'){
                          ?>
                          <a type="button" rel="tooltip" title="Lihat Surat" class="btn btn-info btn-simple btn-xs" href='<?php echo base_url()."index.php/surat_direksi/lihat_gambar/".$d->id_surat."" ?>'>
                          <i class="fa fa-file-image-o"></i>
                          </a>
                          <a type="button" rel="tooltip" title="Edit" class="btn btn-warning btn-simple btn-xs" href='<?php echo base_url()."index.php/surat_direksi/update/".$d->id_surat."" ?>'>
                          <i class="fa fa-pencil"></i>
                          </a>
                          <a type="button" rel="tooltip" title="Hapus" class="btn btn-danger btn-simple btn-xs" onclick="return confirm('Apakah Anda yakin ingin menghapus surat ini ? \n*seluruh berkas pada surat ini juga akan terhapus')" href='<?php echo base_url()."index.php/surat_direksi/do_delete/".$d->id_surat."" ?>'>

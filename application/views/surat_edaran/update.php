    ...
    <main class="page-content content-wrap">
      ...
      <div class="page-inner">
          ...
          <div class="page-title">
            <h3>Edit Surat edaran - <b><?php echo $no ?></h3>
            <div class="page-breadcrumb">
              <ol class="breadcrumb">
              <li><a href="<?php echo base_url() ?>/index.php/beranda">Beranda</a></li>
              <li><a href="<?php echo base_url() ?>/index.php/surat_edaran">Surat edaran</a></li>
              <li class="active">Edit Surat edaran - <b><?php echo $no ?></b></li>
              </ol>
            </div>
            <br>
            <div class="row">
              <div class="col-md-6">
                <a type="submit" class="btn btn-default btn-addon m-b-sm" href='<?php echo base_url()."index.php/surat_edaran/" ?>'><i class="fa fa-angle-left"></i> Kembali</a>
              </div>
            </div>
          </div>
          <!-- End of Navigation -->
            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/surat_edaran/do_update/".$id.""?>" enctype="multipart/form-data">
                      <div class="row">
                      ...
                      <a href="<?php echo base_url()."index.php/surat_edaran"?>" class="pull-left" style="color:gray; text-decoration:underline;"><br><i class="fa fa-angle-left"></i> Kembali ke daftar surat edaran</a>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function(){
        $('#no').change(function(){
              ...
              if(no != ''){
                   $.ajax({
                        url:"<?php echo base_url(); ?>index.php/surat_edaran/check_no_availability",
                        method:"POST",
                        data:{no:no},

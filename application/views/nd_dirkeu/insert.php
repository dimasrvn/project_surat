...
<html>
  <head>
    <title>Tambah ND Direktur Keuangan</title>
    <?php echo $head ?>
  </head>
      ...
      <div class="page-inner">
          ...
          <div class="page-title">
            ...
            <div class="page-breadcrumb">
              ...
              <li class="active">Tambah ND Direktur Keuangan</li>
              </ol>
            </div>
            <br>
            <div class="row">
            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/ND_dirkeu/do_insert"?>" enctype="multipart/form-data">
                      <div class="row">

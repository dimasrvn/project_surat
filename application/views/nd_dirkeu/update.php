...
<html>
  <head>
    <title>Edit ND Direktur Keuangan</title>
    <?php echo $head ?>
  </head>
    ...
    <main class="page-content content-wrap">
      ...
      <div class="page-inner">
          ...
          <div class="page-title">
            <h3>Edit ND Direktur Keuangan - <b><?php echo $no ?></h3>
            <div class="page-breadcrumb">
              ...
              <li class="active">Edit ND Direktur Keuangan - <b><?php echo $no ?></b></li>
              </ol>
            </div>
            <br>
            <div class="row">
            ...
            <div class="panel-body">
              ...
              <div class="card-content">
                <div id="rootwizard">
                  ...
                  <form class="form-horizontal" method="POST" action="<?php echo base_url()."index.php/ND_dirkeu/do_update/".$id.""?>" enctype="multipart/form-data">
                      <div class="row">
                      ...
                      <a href="<?php echo base_url()."index.php/ND_dirkeu"?>" class="pull-left" style="color:gray; text-decoration:underline;"><br><i class="fa fa-angle-left"></i> Kembali ke daftar ND Direktur Keuangan</a>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function(){
        $('#no').change(function(){
              ...
              if(no != ''){
                   $.ajax({
                        url:"<?php echo base_url(); ?>index.php/ND_dirkeu/check_no_availability",
                        method:"POST",
                        data:{no:no},
